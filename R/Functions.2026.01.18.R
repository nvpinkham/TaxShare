...
#' @param min.obs the number of times a taxon has to be observed in a group of sites to be considered present
...
#' @export
tax.shared.plot <- function (tax.res,
                             log = T,
                             min.obs = 1,
